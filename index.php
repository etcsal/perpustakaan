	...
	<li>
        ...
        <li class="header">Laporan</li>
		 ...
		 <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?page=laporan_buku"><i class="fa fa-circle-o"></i> Laporan Buku</a></li>
            <li><a href="?page=laporan_anggota"><i class="fa fa-circle-o"></i> Laporan Anggota</a></li>
			<li><a href="?page=laporan_transaksi"><i class="fa fa-circle-o"></i> Laporan Transaksi Pinjam</a></li>
			<li><a href="?page=laporan_transaksikembali"><i class="fa fa-circle-o"></i> Laporan Transaksi Kembali</a></li>
			<li><a href="?page=laporan_bukuhilang"><i class="fa fa-circle-o"></i> Laporan Buku Hilang</a></li>
			<li><a href="?page=laporan_gantirugibuku"><i class="fa fa-circle-o"></i> Laporan Ganti Rugi Buku</a></li>
          </ul>
        </li>
			   ...
			   if ($page == "lokasibuku") {
				...
				if ($page == "anggota") {
			     ...
			     if ($page == "transaksi_gantirugi") {
			      ...
			      if ($page == "laporan_buku") {
				   if ($aksi == "") {
					   include "page/laporan/laporan_buku.php";
				   }
				  }
				   ...
				   if ($aksi == "") {
					   include "page/laporan/laporan_transaksi.php";
				   }
			   }
			     if ($page == "laporan_transaksikembali") {
				   if ($aksi == "") {
					   include "page/laporan/laporan_transaksikembali.php";
				   }
					}
					
					 if ($page == "laporan_bukuhilang") {
				   if ($aksi == "") {
					   include "page/laporan/laporan_bukuhilang.php";
				   }
					}
			   
			    if ($page == "laporan_gantirugibuku") {
				   if ($aksi == "") {
					   include "page/laporan/laporan_gantirugibuku.php";
				   }
					}
...
$(function () {
  ...
  <script type="text/javascript">
    ...
    $('#Myform').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/export_laporan_transaksi_excel.php',
            data: $(this).serialize(),
 ...
 <script type="text/javascript">
    ...
    $('#Myform1').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/export_laporan_buku_excel.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung1").html(data);
             $('.table').DataTable();
 ...
 <script type="text/javascript">
    ...
    $('#Myform2').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/export_laporan_transaksikembali_excel.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung2").html(data);
             $('.table').DataTable();
...
<script type="text/javascript">
    ...
    $('#Myform3').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/export_laporan_bukuhilang_excel.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung3").html(data);
             $('.table').DataTable();
...
<script type="text/javascript">
    ...
    $('#Myform4').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/export_laporan_gantirugi_excel.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung4").html(data);
             $('.table').DataTable();
