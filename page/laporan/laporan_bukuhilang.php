                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4>Laporan Data Buku Hilang</h4>
                        </div>
	...
	<div class="col-md-12">
	 <div class="content-panel">
        ...
        <tr>
            <td width="50%">
<form action="page/laporan/export_laporan_bukuhilang_excel.php" method="post">
   ...
   <div class="tampung3">
						...
						<tr>
							...
							?>
								...
								<a href="page/laporan/export_laporan_bukuhilang_excel.php"  class="btn btn-primary" style="margin-top:8 px"><i class="fa fa-print"></i>Cetak</a>
